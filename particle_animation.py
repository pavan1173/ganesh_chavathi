...
# NOTE:
# FPS controls how often frames are requested, but the real speed is
# also limited by how much work each 1920x1080 frame requires.
# The shorter timeline + larger mosaic blocks above make the reveal
# finish much faster without removing the main visual effects.
...
def main():
    ...
    print("Preparing premium Krishna reveal...")
    ...
    for i in range(
        ...
        frame = add_reflection(
            canvas,
            REFLECTION_HEIGHT_RATIO
        )

        # Flowers + fireworks begin subtly
        frame = add_particles(
            frame,
            petals,
            blooms,
    ...
    for i in range(
        ...
        # Strong celebration during reveal
        intensity = (
            0.8
            + 0.8
            * math.sin(
    ...
    for i in range(
        ...
        # Stronger particles near final reveal
        frame = add_particles(
            frame,
            petals,
            blooms,
